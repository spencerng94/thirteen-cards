...
export const BrandLogo: React.FC<BrandLogoProps> = ({ size = 'md', className = '' }) => {
  ...
  // 36 segments (10 degrees per unit)
  // Re-engineered for "Box inside a Box" uniform aesthetics.
  const leiwenSegments = Array.from({ length: 36 }).map((_, i) => {
    const angle = i * 10;
    return (
      <g key={i} transform={`rotate(${angle})`}>
        {/* 
            Uniform Imperial Square Meander:
            Spans from radius 285 to 335 (50px depth).
            Mathematically aligned for a "nested box" look.
            Stroke 4.5 for high-precision clarity.
        */}
        <path
          d="M -44 -335 H 44 V -285 H -34 V -325 H 24 V -295 H -14 V -315 H 4"
          fill="none"
        ...
        />
        {/* Mirror-Relief Precision Highlight */}
        <path
          d="M -44 -335 H 44 V -285 H -34 V -325 H 24 V -295 H -14 V -315 H 4"
          fill="none"
          stroke="white"
  ...
  return (
    <div className={`${dimensions} ${className} relative flex items-center justify-center select-none transition-all duration-1000 ease-in-out hover:scale-[1.05] active:scale-95 group`}>
      ...
      >
        <defs>
          {/* 24k "Jewel-Finish" Gold Gradient */}
          <linearGradient id="goldMetallicPremium" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#2d1d07" />
            <stop offset="15%" stopColor="#8b6508" />
            <stop offset="30%" stopColor="#fbf5b7" />
            <stop offset="45%" stopColor="#ffffff" />
            <stop offset="60%" stopColor="#d4af37" />
            <stop offset="85%" stopColor="#5c2e00" />
            <stop offset="100%" stopColor="#2d1d07" />
          </linearGradient>

          {/* Deep Imperial Cinnabar Lacquer (Crystalline Depth) */}
          ...
          {/* Massive Gold Bullion Rim Gradient */}
          ...
          <filter id="gold3DBevelPremium" x="-200%" y="-200%" width="500%" height="500%" colorInterpolationFilters="sRGB">
            ...
            <feSpecularLighting in="blur" surfaceScale="38" specularConstant="3.5" specularExponent="95" lightingColor="#ffffff" result="spec1">
              <fePointLight x="-3000" y="-3000" z="5000" />
            </feSpecularLighting>
            <feComposite in="spec1" in2="SourceAlpha" operator="in" result="bevel1" />
            <feSpecularLighting in="blur" surfaceScale="25" specularConstant="2.4" specularExponent="50" lightingColor="#fffaf0" result="spec2">
              <fePointLight x="3000" y="3000" z="3000" />
            </feSpecularLighting>
          ...
          {/* Premium "Halo" Glow Filter */}
          <filter id="goldBloomPremium" x="-400%" y="-400%" width="900%" height="900%">
            <feGaussianBlur in="SourceAlpha" stdDeviation="2.5" result="tightBlur" />
            <feFlood floodColor="#fffde7" floodOpacity="0.8" result="coreColor" />
            <feComposite in="coreColor" in2="tightBlur" operator="in" result="coreGlow" />
            <feGaussianBlur in="SourceAlpha" stdDeviation="45" result="broadBlur" />
            <feFlood floodColor="#facc15" floodOpacity="0.15" result="broadColor" />
            <feComposite in="broadColor" in2="broadBlur" operator="in" result="broadGlow" />
            <feMerge>
              <feMergeNode in="broadGlow" />
          ...
          <pattern id="lacquerTexture" x="0" y="0" width="1024" height="1024" patternUnits="userSpaceOnUse">
             <circle r="512" cx="512" cy="360" fill="none" stroke="white" strokeOpacity="0.04" strokeWidth="0.5" />
          </pattern>
        </defs>

        {/* Global Lighting Aura */}
        <g style={{ filter: `drop-shadow(0 140px 280px rgba(0, 0, 0, 1)) drop-shadow(0 0 200px rgba(234, 179, 8, 0.18))` }}>
          
          {/* MINTED IMPERIAL COIN ASSEMBLY - Adjusted size to radius 355 */}
          <g transform="translate(512, 360)">
             {/* Massive Bullion Outer Rim (Radius 355) */}
             <circle r="355" fill="url(#goldRimGradient)" filter="url(#gold3DBevelPremium)" />
             
             {/* Polished Lacquer Face (Radius 345) */}
             <circle r="345" fill="url(#imperialRedGradient)" />
             <circle r="345" fill="url(#lacquerTexture)" opacity="0.4" />

             {/* Uniform "Box inside Box" Leiwen Band (Radius 285 to 335) */}
             <g filter="url(#gold3DBevelPremium)">
               {leiwenSegments}
             </g>

             {/* Precision-Cut Inner Track Ring (Hugs inside of Leiwen at Radius 275) */}
             <circle 
                r="275" 
                fill="none" 
          ...
          {/* Central Spade & 13 Logo Assembly - Perfectly Preserved */}
          <g transform="translate(0, 75)">
            ...
            <text 
              ...
              fill="url(#goldMetallicPremium)"
              filter="url(#goldBloomPremium)"
              style={{ textTransform: 'uppercase', paintOrder: 'stroke fill', letterSpacing: '-0.02em' }}
            >
              THIRTEEN
            </text>

            {/* Symmetrical Sovereign Divider */}
            <g filter="url(#goldBloomPremium)">
              <rect 
                x="115" 
                y="888" 
                width="794" 
              ...
              {/* Left Decoration - Imperial Cross */}
              <g transform="translate(60, 865)">
                <rect x="-4" y="0" width="14" height="4" fill="url(#goldMetallicPremium)" />
                <rect x="22" y="0" width="14" height="4" fill="url(#goldMetallicPremium)" />
                <rect x="-4" y="44" width="14" height="4" fill="url(#goldMetallicPremium)" />
                <rect x="22" y="44" width="14" height="4" fill="url(#goldMetallicPremium)" />
                <rect x="10" y="0" width="12" height="48" fill="url(#goldMetallicPremium)" transform="rotate(-40 16 24)" />
                <rect x="10" y="0" width="12" height="48" fill="url(#goldMetallicPremium)" transform="rotate(40 16 24)" />
              </g>
              
              {/* Right Decoration - Imperial Scepter */}
              <g transform="translate(920, 865)">
                <rect x="-6" y="0" width="56" height="4" fill="url(#goldMetallicPremium)" />
                <rect x="0" y="0" width="10" height="48" fill="url(#goldMetallicPremium)" />
                <rect x="17" y="0" width="10" height="48" fill="url(#goldMetallicPremium)" />
                <rect x="34" y="0" width="10" height="48" fill="url(#goldMetallicPremium)" />
                <rect x="-6" y="44" width="56" height="4" fill="url(#goldMetallicPremium)" />
              </g>
            </g>
            ...
            <text 
              ...
              textLength="680"
              lengthAdjust="spacing"
              style={{ textTransform: 'uppercase', paintOrder: 'stroke fill', opacity: 0.95, letterSpacing: '0.28em' }}
            >
              FIRST TO ZERO WINS
            </text>
          </g>
