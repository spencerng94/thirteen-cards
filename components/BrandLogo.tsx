...
export const BrandLogo: React.FC<BrandLogoProps> = ({ size = 'md', className = '' }) => {
  ...
  return (
    <div className={`${dimensions} ${className} relative flex items-center justify-center select-none transition-all duration-1000 ease-in-out hover:scale-[1.05] active:scale-95 group`}>
      ...
      >
        <defs>
          {/* Photorealistic High-End Gold Metallic Gradient */}
          <linearGradient id="goldMetallicPremium" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#4b3412" />
            <stop offset="10%" stopColor="#8b6508" />
            <stop offset="35%" stopColor="#fbf5b7" />
            <stop offset="50%" stopColor="#ffffff" />
            <stop offset="65%" stopColor="#d4af37" />
            <stop offset="85%" stopColor="#b8860b" />
            <stop offset="100%" stopColor="#4b3412" />
          </linearGradient>

          {/* Advanced Studio-Grade Bevel & Lighting Filter */}
          <filter id="gold3DBevelPremium" x="-50%" y="-50%" width="200%" height="200%" colorInterpolationFilters="sRGB">
            <feGaussianBlur in="SourceAlpha" stdDeviation="2.2" result="blur" />
            <feSpecularLighting in="blur" surfaceScale="22" specularConstant="2.8" specularExponent="50" lightingColor="#ffffff" result="spec1">
              <fePointLight x="-1500" y="-1500" z="3000" />
            </feSpecularLighting>
            <feComposite in="spec1" in2="SourceAlpha" operator="in" result="bevel1" />

            <feSpecularLighting in="blur" surfaceScale="15" specularConstant="2" specularExponent="35" lightingColor="#fef3c7" result="spec2">
              <fePointLight x="1800" y="1800" z="2000" />
            </feSpecularLighting>
            <feComposite in="spec2" in2="SourceAlpha" operator="in" result="bevel2" />

            <feComposite in="SourceGraphic" in2="bevel1" operator="arithmetic" k1="0" k2="1" k3="1.5" k4="0" result="lit1" />
            <feComposite in="lit1" in2="bevel2" operator="arithmetic" k1="0" k2="1" k3="0.8" k4="0" result="finalGold" />
          </filter>

          {/* Refined Cinematic Bloom */}
          <filter id="goldBloomPremium" x="-150%" y="-150%" width="400%" height="400%">
            <feGaussianBlur in="SourceAlpha" stdDeviation="1.2" result="tightBlur" />
            ...
            <feGaussianBlur in="SourceAlpha" stdDeviation="8" result="broadBlur" />
            <feFlood floodColor="#facc15" floodOpacity="0.2" result="broadColor" />
        ...
        <g style={{ filter: `drop-shadow(0 30px 50px rgba(0, 0, 0, 0.9)) drop-shadow(0 0 40px rgba(234, 179, 8, 0.15))` }}>
          <g filter="url(#gold3DBevelPremium)">
            {/* Spade Logo Component - ABSOLUTE PATH GEOMETRY PRESERVED */}
            <path 
            ...
            {/* Main Brand Title - Re-balanced position */}
            <text 
              x="512" 
              y="700" 
              textAnchor="middle" 
              ...
              fill="url(#goldMetallicPremium)"
              filter="url(#goldBloomPremium)"
              style={{ textTransform: 'uppercase', paintOrder: 'stroke fill', letterSpacing: '-0.05em' }}
            >
              THIRTEEN
            </text>

            {/* Cinematic Symmetrical Divider Assembly */}
            <g filter="url(#goldBloomPremium)">
              {/* Central Horizontal Line - Extended with tight hairline thickness */}
              <rect 
                x="115" 
                y="748" 
                width="794" 
              ...
              {/* Left Decoration: Elegant 'X' (10) - Repositioned for perfect gap */}
              ...
              {/* Right Decoration: Elegant 'III' (3) - Repositioned for perfect gap */}
            ...
            {/* Subtitle - Symmetrically spaced relative to the divider line */}
            <text 
              x="512" 
              y="805" 
              textAnchor="middle" 
              ...
              textLength="680"
              lengthAdjust="spacing"
              style={{ textTransform: 'uppercase', paintOrder: 'stroke fill', opacity: 0.98, letterSpacing: '0.15em' }}
            >
              FIRST TO ZERO WINS
            </text>
          </g>
